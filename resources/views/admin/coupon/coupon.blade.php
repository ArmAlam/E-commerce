            ...
            <form method="POST" action="{{ route('store.coupon') }}">
                ...
                <div class="modal-body pd-20">               
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="category_name" placeholder="Coupon Code" name="coupon" required>
                    </div>
                    <div class="form-group">
                        <label for="category_name">Coupon Discount (%)</label>
                        <input type="text" class="form-control" id="category_name" placeholder="Coupon Discount" name="discount" required>
                    </div>
                </div><!-- modal-body -->
