              ...
              <div class="row mg-b-25">
                ...
                <div class="col-lg-12">
                    <div class="form-group ">
                      ...
                      <input type="text" class="form-control" name="video_link" placeholder="Video Link" value="{{ $product->video_link }}">
                    </div>
                </div>
                    ...
                    @csrf
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                ...
                                <label class="custom-file">
                                    <input type="file" class="custom-file-input" name="image_one" id="file" onchange="readURL(this);" accept="image">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                ...
                                <label class="custom-file">
                                    <input type="file" class="custom-file-input" name="image_two" id="file" onchange="readURL1(this);" accept="image">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                ...
                                <label class="custom-file">
                                    <input type="file" class="custom-file-input" name="image_three" id="file" onchange="readURL2(this);"  accept="image">
