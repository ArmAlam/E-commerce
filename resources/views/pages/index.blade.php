                                ...
                                @foreach ($featured as $row)
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($row->image_one)}}" style="height:120px; width:130px;" alt=""></div>
                        ...
                        <div class="product_panel panel">
                            <div class="featured_slider slider">
                                ...
                                <div class="featured_slider_item">
                                    <div class="border_active"></div>
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset($bst->image_one)}}" style="height:120px; width:120px"></div>
                                        <div class="product_content">
                                            @if ($row->discount_price == NULL )
                                            ...
                                            @endif
                                            <div class="product_name"><div><a href="product.html">{{ $bst->product_name}}</a></div></div>
                                            <div class="product_extras">
                                                <div class="product_color">
                                                    <input type="radio" checked name="product_color" style="background:#b19c83">
                                                    <input type="radio" name="product_color" style="background:#000000">
                        ...
                        <div class="container fill_height">
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    ...
                                    <div class="banner_2_text">{{ $row->brand_name }}
                                    <br> Product ID: {{$row->product_code}} </div>
                                        <div class="rating_r rating_r_4 banner_2_rating"><i></i><i></i><i></i><i></i><i></i></div>
                                        <div class="butt`banner_2_button"><a href="#">Explore</a></div>
                                    </div>
