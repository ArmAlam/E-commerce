                 ...
                 <div class="col-lg-5 " style=" padding: 20px;">
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('payment.process') }}" id="contact_form" method="post">
                           ...
                           <div class="form-group">
                                <ul class="logos_list" style="margin-left; 120px;" >
                                    ...
                                    <li><input type="radio" name="payment" value="mollie"> <img src="{{ asset('public/frontend/images/mollie.png') }}" style="width: 100px; height: 80px;"></li>
                                 </ul>
                            </div><br>
